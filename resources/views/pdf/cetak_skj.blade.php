...
<body>
    <div class="container">
        ...
        <div class="keterangan">
            @if ($surat->jenis_surat == 'Surat Keterangan Janda')
            <p class="mt-4">Adalah benar berstatus <strong>Janda</strong> <span style="text-transform: capitalize">({{ ucfirst($surat->jenis_cerai) }})</span> dari suaminya <strong>{{ strtoupper($surat->nama_pasangan) }}</strong>.</p>
            @else
            <p class="mt-4">Adalah benar berstatus <strong>Duda</strong> <span style="text-transform: capitalize">({{ ucfirst($surat->jenis_cerai) }})</span> dari istrinya <strong>{{ strtoupper($surat->nama_pasangan) }}</strong>.</p>
            @endif
