                ...
                <div class="card mb-3">
                    <div class="row g-0">
                      ...
                      <div class="col-md-3 d-flex justify-content-center align-items-center ">
                        <a href="/buatSKTM">
                            <button type="button" class="btn btn-secondary my-2 mx-2 w-100">Ajukan</button>
                        </a>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-sm-7 col-md-6 col-lg-8 col-xl-9 mx-auto">
                <div class="card mb-3">
                    <div class="row g-0">
                      <div class="col-md-9">
                        <div class="card-body">
                          <h5 class="card-title badge bg-secondary text-white">Surat Keterangan Usaha</h5>
            ...
            <div class="col-sm-7 col-md-6 col-lg-8 col-xl-9 mx-auto">
                <div class="card mb-3">
                    <div class="row g-0">
                      <div class="col-md-9">
                        <div class="card-body">
                          <h5 class="card-title badge bg-secondary text-white">Surat Keterangan Domisili</h5>
            ...
            <div class="col-sm-7 col-md-6 col-lg-8 col-xl-9 mx-auto">
                <div class="card mb-3">
                    <div class="row g-0">
                      <div class="col-md-9">
                        <div class="card-body">
                          <h5 class="card-title badge bg-secondary text-white">Surat Keterangan Janda/Duda</h5>
