                    ...
                    <div class="row g-0">
                      <div class="col-md-9">
                        <div class="card-body">
                          ...
                          <p class="card-text" style="text-align:justify;">Surat Keterangan Tidak Mampu adalah dokumen resmi yang membuktikan bahwa seseorang atau keluarganya tidak memiliki kemampuan finansial untuk memenuhi kebutuhan dasar mereka. Ini digunakan untuk mengajukan bantuan sosial atau keringanan biaya.</p>
                        </div>
                      </div>
                    ...
                    <div class="row g-0">
                      <div class="col-md-9">
                        <div class="card-body">
                          ...
                          <p class="card-text" style="text-align:justify;">Surat Keterangan Usaha adalah dokumen yang memberikan informasi terkait dengan jenis, alamat, dan detail usaha yang sedang dijalankan oleh seseorang atau perusahaan. Dokumen ini digunakan berbagai keperluan, seperti untuk mengajukan izin usaha, memenuhi persyaratan perbankan, atau sebagai bukti eksistensi usaha dalam berbagai transaksi bisnis.</p>
                        </div>
                      </div>
                      <div class="col-md-3 d-flex justify-content-center align-items-center ">
                        <a href="/buatSKU">
                    ...
                    <div class="row g-0">
                      <div class="col-md-9">
                        <div class="card-body">
                          ...
                          <p class="card-text" style="text-align:justify;">Surat Keterangan Domisili adalah dokumen resmi yang memberikan bukti alamat tempat tinggal seseorang atau entitas pada suatu wilayah tertentu. Sering digunakan untuk keperluan administratif seperti pembuatan dokumen, pembukaan rekening bank, atau proses perizinan.</p>
                        </div>
                      </div>
                      <div class="col-md-3 d-flex justify-content-center align-items-center ">
                        <a href="/buatSKD">
