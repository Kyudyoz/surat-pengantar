			...
			<div class="row vh-100">
				<div class="col-sm-8 col-md-8 col-lg-10 col-xl-10 mx-auto d-table h-100 pb-4">
					<div class="d-table-cell align-middle">
						...
						<a href="/" class="btn btn-danger mb-2"><i class="align-middle" data-feather="arrow-left"></i> Kembali</a>

						<div class="card">
							<div class="row g-0">
								<div class="col-md-4 text-center">
									<img src="{{ URL::asset('assets/img/icons/logo2.png') }}" class="img-fluid rounded-start"  alt="...">
								</div>
								<div class="col-md-8">
									<div class="card-body">
										<div class="m-sm-3">
