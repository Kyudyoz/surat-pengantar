            ...
            <div class="col-sm-10 col-md-8 col-lg-8 col-xl-8 mx-auto d-table h-100">
                <div class="d-table-cell align-middle">
                    ...
                    <div class="text-center mt-4">
                        <h1 class="h2">Surat Keterangan Kepemilikan Rumah</h1>
                        <p class="lead">
                                    ...
                                    <div class="m-sm-8">
                                        <form action="/updateSKKR/{{ $surat->id }}" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-lg @error('lokasi') is-invalid @enderror" required type="text" name="lokasi" placeholder="Masukan Alamat" value="{{ old('lokasi', $surat->lokasi) }}"/>
                                                @error('lokasi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
