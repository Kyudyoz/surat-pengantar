                        ...
                        <div class="card-body">
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="col-sm-7 col-md-6 col-lg-7 col-xl-9 mx-auto">
                                    <div class="m-sm-8">
                                        <form action="/updateSKD/{{ $surat->id }}" method="post">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-lg @error('tinggal') is-invalid @enderror" required type="text" name="tinggal" placeholder="Saat ini tinggal di rumah siapa?" value="{{ old('tinggal', $surat->tinggal) }}"/>
                                                @error('tinggal')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
