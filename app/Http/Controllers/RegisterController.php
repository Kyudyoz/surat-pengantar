...
class RegisterController extends Controller
{
    ...
    {
       $users = User::where('nik', $request->nik)->where('status', 'Ditolak RT')->orWhere('status', 'Ditolak Admin')->get();

       $users2 = User::where('nik', $request->nik)->get();
       if ($users -> count()) {
        $validatedData = $request->validate([
           ...
           User::where('nik', $request->nik)->where('status', 'Ditolak RT')->orWhere('status', 'Ditolak Admin')->update($validatedData);
